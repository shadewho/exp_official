...
_PROP_NAMES = [
    ...
    # XR Core sub-sections
    "dev_xr_core_status","dev_xr_core_flow",
...
def ensure_scene_props():
    ...
    # ---- XR Core sub-sections ----
    add("dev_xr_core_status", bpy.props.BoolProperty(name="XR Status", default=True))
    add("dev_xr_core_flow",   bpy.props.BoolProperty(name="XR Flow", default=True))
    ...
    # NEW: raw dump toggle (replaces what “Custom” used to give, but scoped to XR)
    ...
    add("dev_geom_down_dyn_auth", bpy.props.BoolProperty(
        name="XR DOWN dynamic authority", default=False))
