#Exploratory/Exp_UI/interface/drawing/config.py
...
TEMPLATE_MARGIN_HORIZONTAL = 0.08
TEMPLATE_MARGIN_TOP = 0.2
TEMPLATE_MARGIN_BOTTOM = 0.15

LOADING_IMAGE_SCALE = 0.2     # 20% of the template width
LOADING_IMAGE_OFFSET_X = -.38  # relative offset from center in X
...
ARROW_LEFT_PATH  = os.path.join(os.path.dirname(__file__), "ui_templates", "arrow_left.jpg")
ARROW_RIGHT_PATH = os.path.join(os.path.dirname(__file__), "ui_templates", "arrow_right.jpg")
